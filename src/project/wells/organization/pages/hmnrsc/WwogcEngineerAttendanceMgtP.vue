...
const initGrid = defineGrid((data, view) => {
  const columns = [
    ...
    { fieldName: 'bizAgntPrtnrNo', header: t('MSG_TXT_EPNO'), width: '150', styleName: 'text-left, rg-button-icon--search', rules: 'required', editor: { type: 'text' }, editable: true, button: 'action' },
