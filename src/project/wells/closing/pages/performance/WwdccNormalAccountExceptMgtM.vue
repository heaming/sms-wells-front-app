...
const initGridMain = defineGrid((data, view) => {
  const columns = [
    ...
    { fieldName: 'pdCd', header: t('MSG_TXT_PRDT_CODE'), width: '120', styleName: 'text-center', rules: 'required' },
...
const initGridCntr = defineGrid((data, view) => {
  const columns = [
    ...
    { fieldName: 'cntrDtl', header: t('MSG_TXT_CNTR_DTL'), width: '120', styleName: 'text-center rg-button-icon--search', button: 'action', rules: 'required' },
