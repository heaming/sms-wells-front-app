...
const initGridSnglPmntContractList = defineGrid((data, view) => {
  const fields = [
    ...
    { fieldName: 'fnlAmt' }, // 총판매금
    { fieldName: 'sellAmt' }, // 공급가
    { fieldName: 'vat' }, // 부가세
    { fieldName: 'cntrAmt' }, // 확정청약금
    { fieldName: 'istmIntAmt' }, // 할부이자금액
    { fieldName: 'feeAckmtBaseAmt' }, // 수수료
    { fieldName: 'crpUc' }, // 법인미수
    { fieldName: 'totDscAmt' }, // 총할인금
    { fieldName: 'feeAckmtCt' }, // 인정건수
    { fieldName: 'ackmtPerfAmt' }, // 총인정금
    { fieldName: 'feeAckmtTotAmt' }, // 총기준수수료
    { fieldName: 'feeFxamYn' }, // 수수료정액여부
    { fieldName: 'pdSaleFee' }, // 판매수수료
    { fieldName: 'cashBlam' }, // 현금잔액
    { fieldName: 'istmMcn' }, // 할부개월수
    { fieldName: 'mmIstmAmt' }, // 월할부금
    { fieldName: 'istmPcamAmt' }, // 총할부금액
  ...
  const columns = [
    ...
    { fieldName: 'slDt', header: t('MSG_TXT_DT_OF_SALE'), width: '136', styleName: 'text-center' }, // 매출일
    { fieldName: 'cntrCanDt', header: t('MSG_TXT_CAN_D'), width: '136', styleName: 'text-center' }, // 취소일
    { fieldName: 'cpsDt', header: t('MSG_TXT_COMP_D'), width: '136', styleName: 'text-center' }, // 보상일
    { fieldName: 'slPasgDt', header: t('MSG_TXT_SL_PASG_DT'), width: '136', styleName: 'text-center' }, // 매출경과일
    ...
    { fieldName: 'booSellYn', header: t('TXT_MSG_BOO_SELL_YN'), width: '136' }, // 예약판매여부
    ...
    { fieldName: 'svPrd', header: t('MSG_TXT_MNGT_PRD'), width: '136', styleName: 'text-center' }, // 관리주기
    ...
    { fieldName: 'pdQty', header: t('MSG_TXT_PRODUCT_QTY'), width: '197' }, // 상품 수량
