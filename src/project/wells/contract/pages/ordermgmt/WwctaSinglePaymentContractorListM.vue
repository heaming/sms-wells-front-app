...
const initGridSnglPmntContractorList = defineGrid((data, view) => {
  const fields = [
    ...
    { fieldName: 'sellPrtnrNmEncr' }, // 판매자명(암호화)
  ...
  const columns = [
    ...
    { fieldName: 'copnDvNm', header: t('MSG_TXT_CST_DV'), width: '138', styleName: 'text-center' }, // 고객구분명
    { fieldName: 'rnmno',
      header: t('MSG_TXT_RRNO_BZRNO'),
      width: '160',
    ...
    { fieldName: 'freExpnCnfmDtm', header: `${t('MSG_TXT_FRE_EXPN')}${t('MSG_TXT_DTRM_DATE')}`, width: '136', styleName: 'text-center', datetimeFormat: 'date' }, // 무료체험확정일
    ...
    { fieldName: 'sellAmt', header: t('MSG_TXT_SPLPRC'), width: '136', styleName: 'text-right' }, // 공급가
    ...
    { fieldName: 'rdadr', header: `${t('MSG_TXT_CNTRT')} ${t('MSG_TXT_DETAIL_ADDR')}`, width: '230', styleName: 'text-left' }, // 계약자 상세주소
    ...
    { fieldName: 'istlcDadr', header: `${t('MSG_TXT_INSTR')} ${t('MSG_TXT_DETAIL_ADDR')}`, width: '230', styleName: 'text-left' }, // 설치자 상세주소
    ...
    { fieldName: 'sppOrdIvcNo', header: t('MSG_TXT_IVC_INF'), width: '157', styleName: 'text-center' }, // 송장정보
    ...
    { fieldName: 'pdQty', header: t('MSG_TXT_PROD_QUANT'), width: '100', styleName: 'text-right' }, // 상품수량
