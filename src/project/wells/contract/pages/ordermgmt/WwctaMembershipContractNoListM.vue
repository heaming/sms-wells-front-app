...
<template>
  ...
  <div class="result-area">
    ...
    <kw-grid
      ref="grdMembershipContractorNoList"
      name="grdMembershipContractorNoList"
      :visible-rows="pageInfo.pageSize"
      @init="initGridMembershipContractorNoList"
    />
    <kw-pagination
      v-model:page-index="pageInfo.pageIndex"
      v-model:page-size="pageInfo.pageSize"
...
// Function & Event
// -------------------------------------------------------------------------------------------------
const grdMembershipContractorNoList = ref(getComponentType('KwGrid'));
...
// Initialize Grid
// -------------------------------------------------------------------------------------------------
const initGridMembershipContractorNoList = defineGrid((data, view) => {
  const fields = [
    ...
    { fieldName: 'etcVal2' }, // 기타2(할인개월)
    { fieldName: 'etcVal3' }, // 기타3(할인금액)
    { fieldName: 'etcVal4' }, // 기타4(할인구분)
    { fieldName: 'etcVal5' }, // 기타5
  ];
  ...
  const columns = [
    ...
    { fieldName: 'lcjejo', header: t('MSG_TXT_MAKER'), width: '138' }, // 제조사
    ...
    { fieldName: 'ackmtPerfAmt', header: t('TXT_MSG_ACKMT_AMT'), width: '138', styleName: 'text-right' }, // 인정금액
    ...
    { fieldName: 'mpyMthdTpNm', header: `${t('MSG_TXT_MEMBERSHIP')}${t('MSG_TXT_FNT_DV')}`, width: '136' }, // 멤버십이체구분
    ...
    { fieldName: 'cntrCralTno', header: t('MSG_TXT_CNTRT_CPHON_NO'), width: '136', styleName: 'text-center' }, // 계약자휴대전화번호
    ...
    { fieldName: 'istCralTno', header: t('MSG_TXT_INSTR_PH_NO'), width: '136', styleName: 'text-center' }, // 설치자휴대전화번호
    ...
    { fieldName: 'etcVal2', header: t('MSG_TXT_ETC_2_DSC_MCNT'), width: '136', styleName: 'text-right' }, // 기타2(할인개월)
    { fieldName: 'etcVal3', header: t('MSG_TXT_ETC_3_DSC_AMT'), width: '136', styleName: 'text-right' }, // 기타3(할인금액)
    { fieldName: 'etcVal4', header: t('MSG_TXT_ETC_4_DSC_DV'), width: '136', styleName: 'text-center' }, // 기타4(할인구분)
    { fieldName: 'etcVal5', header: t('MSG_TXT_ETC') + 5, width: '136', styleName: 'text-center' }, // 기타5
  ];
