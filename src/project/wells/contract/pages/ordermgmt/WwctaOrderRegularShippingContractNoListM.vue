...
async function fetchData() {
  ...
  res = await dataService.get('/sms/wells/contract/contracts/order-detail-mngt/regular-shippings/paging', { params: { ...cachedParams, ...pageInfo.value } });
...
// Initialize Grid
// -------------------------------------------------------------------------------------------------
function initGridRglrDlvrContractNoList(data, view) {
// const initGridRglrDlvrContractNoList = defineGrid((data, view) => {
  ...
  const columns = [
    { fieldName: 'cntrDtlNo', header: t('MSG_TXT_CNTR_NO'), width: '180', styleName: 'rg-button-link text-center', renderer: { type: 'button' }, preventCellItemFocus: true }, // 계약번호
    ...
    { fieldName: 'shpadrRdadr', header: t('MSG_TXT_DETAIL_ADDR'), width: '231', styleName: 'text-left' }, // 설치정보-상세주소
  ...
  view.setColumnLayout([
    'cntrDtlNo', 'ordrInfoView',
    {
      ...
      items: ['dgr3LevlDgPrtnrNo', 'dgr3LevlDgPrtnrNm', 'dgr3LevlOgCd', 'sellPrtnrNo', 'prtnrKnm', 'sellPrtnrCralTno'],
    },
    {
    ...
    },
    {
      ...
      direction: 'horizontal', // merge type
      items: ['rcgvpKnm', 'shpadrCralTno', 'shpadrAdrZip', 'shpadrRnadr', 'shpadrRdadr'],
    },
    {
    ...
    'copnDvNm',
    {
      ...
      direction: 'horizontal', // merge type
      items: ['mchnSellTpNm', 'mchnCntrNo', 'mchnRcgvpKnm', 'mchnPdCd', 'mchnPdNm', 'mchnSvTpNm', 'mchnSvPrd', 'mchnPdMclsfNm', 'mchnPdLclsfNm'],
    },
    {
    ...
    },
    {
      ...
      direction: 'horizontal', // merge type
      items: ['lkCntrDtlNo', 'lkCstKnm', 'lkPdCd', 'lkPdNm', 'lkIstDt', 'lkIstNmnN', 'lkReqdDt', 'connPdView'],
    },
    {
