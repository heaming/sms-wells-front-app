...
const gridLayout = ref({
  ...
  613: ['cntrDtlNo', 'cstKnm', 'istYm', 'cntrChAkCn', 'fstRgstUsrNm', 'fstRgstDtm'], // 미관리제품 설치일자 변경
  615: ['cntrDtlNo', 'cstKnm', 'pdctIdno', 'cntrChAkCn', 'fstRgstUsrNm', 'fstRgstDtm'], // 시리얼 번호 변경
  616: ['cntrDtlNo', 'cstKnm', 'stpStrtYm', 'stpEndYm', 'mobileTelNo', 'cntrChAkCn', 'fstRgstUsrNm', 'fstRgstDtm'], // 법인 코로나 렌탈중지
  617: ['cntrDtlNo', 'cstKnm', 'stpStrtYm', 'cntrChAkCn', 'fstRgstUsrNm', 'fstRgstDtm'], // 법인 코로나 렌탈중지 취소
  618: ['cntrDtlNo', 'cstKnm', 'feeFxamYn', 'cntrChAkCn', 'fstRgstUsrNm', 'fstRgstDtm'], // 수수료 정액여부 변경
  619: ['cntrDtlNo', 'cstKnm', 'pmotDscMcn', 'pmotDscAmt', 'mobileTelNo', 'cntrChAkCn', 'fstRgstUsrNm', 'fstRgstDtm'], // 프로모션 렌탈료 할인
...
const initGrdRental = defineGrid((data, view) => {
  const columns = [
    ...
    { fieldName: 'ackmtPerfAmt', header: t('MSG_TXT_FEE_ACKMT_CNT'), width: '120', styleName: 'text-right', dataType: 'number' }, // [ 인정실적금액]
    ...
    { fieldName: 'stpStrtYm', header: `${t('MSG_TXT_STP_PRD')}(${t('MSG_TXT_STRT')})`, width: '120', styleName: 'text-center', datetimeFormat: 'yyyy-MM-dd' }, // [시작기간(중지시작년월)]
    { fieldName: 'stpEndYm', header: `${t('MSG_TXT_STP_PRD')}(${t('MSG_TXT_SHUTDOWN')})`, width: '120', styleName: 'text-center', datetimeFormat: 'yyyy-MM-dd' }, // [종료기간 (중지종료년월)]
    { fieldName: 'mobileTelNo', header: t('MSG_TXT_RPLY') + t('MSG_TXT_CONTACT'), width: '150', styleName: 'text-center' }, // [ 휴대전화]
    ...
    { fieldName: 'bfsvcBzsDvCd', header: t('MSG_TXT_CLSF_BS'), width: '120', styleName: 'text-center' }, // [ BS업체구분코드]
    { fieldName: 'splyBzsDvCd', header: t('MSG_TXT_CLSF_BUS'), width: '120', styleName: 'text-center' }, // [ 조달업체구분코드]
