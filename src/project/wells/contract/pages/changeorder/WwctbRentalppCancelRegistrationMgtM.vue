        ...
        <kw-form cols="3">
          <kw-form-row>
            ...
            <kw-form-item :label="$t('MSG_TXT_WDWAL_DT')">
              <p>{{ stringUtil.getDateFormat(cancelDetail.mshWdwalDt) }}</p>
            </kw-form-item>
          </kw-form-row>
          ...
          <kw-form-row>
            ...
            <kw-form-item :label="$t('MSG_TXT_DSC_AGG_AMT')">
              <p>{{ stringUtil.getNumberWithComma(cancelDetail.dscAggAmt??'') }}</p>
            </kw-form-item>
            <!-- row5 조정누계액 -->
            <kw-form-item :label="$t('MSG_TXT_CTR_AGG_AMT')">
              <p>{{ stringUtil.getNumberWithComma(cancelDetail.ctrAggAmt??'') }}</p>
            </kw-form-item>
            <!-- row5 매출잔액 -->
...
function initGridMembership(data, view) {
  const columns = [
    { fieldName: 'col11', header: t('MSG_TXT_GRP_NO'), width: '100', styleName: 'text-center' }, // [그룹번호]
    { fieldName: 'col12', header: t('MSG_TXT_MSH_DV'), width: '100', styleName: 'text-center' }, // [멤버십구분]
    { fieldName: 'col13', header: t('MSG_TXT_WDWAL') + t('MSG_TXT_YEAR'), width: '100', styleName: 'text-center' }, // [탈퇴년]
    ...
    { fieldName: 'col16', header: t('MSG_TXT_DSC') + t('MSG_TXT_APPLY'), width: '100', styleName: 'text-center' }, // [할인적용]
    { fieldName: 'col17', header: t('MSG_TXT_MEM_DUES'), width: '100', styleName: 'text-center' }, // [멤버십회비]
    { fieldName: 'col18', header: `${t('MSG_TXT_RGST_COST_DSC_AMT')} ${t('MSG_TXT_LVY_AMT')}`, width: '100', styleName: 'text-center' }, // [등록비할인금액 부과액]
    { fieldName: 'col19', header: t('MSG_TXT_RES_MCNT'), width: '100', styleName: 'text-center' }, // [잔여개월]
    { fieldName: 'col21', header: t('MSG_TXT_REST') + t('MSG_TXT_CHARGE'), width: '100', styleName: 'text-center' }, // [잔여요금]
    { fieldName: 'col22', header: `${t('MSG_TXT_REST') + t('MSG_TXT_CHARGE')} 10%${t('MSG_TXT_LVY_AMT')}`, width: '100', styleName: 'text-center' }, // [잔여요금 10%부과액]
    { fieldName: 'col23', header: t('MSG_TXT_DSC') + t('MSG_TXT_RTAM'), width: '100', styleName: 'text-center' }, // [할인반환금]
    { fieldName: 'col24', header: `${t('MSG_TXT_COM_TOT')} ${t('MSG_TXT_RTAM')}`, width: '100', styleName: 'text-center' }, // [총 반환금액]
