...
const initGrid = defineGrid((data, view) => {
  const columns = [
    ...
    { fieldName: 'rsgAplcDt', header: t('MSG_TXT_CANC_RQDT'), width: '100', styleName: 'text-center', datetimeFormat: 'yyyy-MM-dd' }, // [취소요청일자]
    ...
    { fieldName: 'pdGdCd', header: t('MSG_TXT_GD'), width: '100', styleName: 'text-center' }, // [등급]
