...
const initGrdMain = defineGrid((data, view) => {
  ...
  const columns = [
    ...
    { fieldName: 'col2', header: t('MSG_TXT_ORD_INQ_DT'), width: '120', styleName: 'text-center', datetimeFormat: 'date' },
    { fieldName: 'col3', header: t('MSG_TXT_CNTR_DTL_NO'), width: '120', styleName: 'text-center' },
    { fieldName: 'col4', header: `${t('MSG_TXT_ORD_NO')}(${t('MSG_TXT_SEC')})`, width: '180', styleName: 'text-center' },
    ...
    { fieldName: 'col8', header: `${t('MSG_TXT_PRDT_NM')}(${t('MSG_TXT_TXT_MSG_PD_HCLSF_ID')})`, width: '240', styleName: 'text-left' },
    { fieldName: 'col9', header: `${t('MSG_TXT_PRDT_NM')}(${t('MSG_TXT_TXT_MSG_PD_LCLSF_ID')})`, width: '240', styleName: 'text-left' },
    ...
    { fieldName: 'col14', header: t('MSG_TXT_INST_DT'), width: '134', styleName: 'text-center', datetimeFormat: 'date' },
  ...
  data.setRows([
    { col1: '고객명 의심', col2: '2022-10-01', col3: '1234-567890', col4: '000000000', col5: '김고객', col6: '12345', col7: '서울 관악구 난곡로 00길 1-1 교원A동 105호', col8: '삼성 건조기 9kg', col9: '건조기(DV90T5540)', col10: '02-111-1234', col11: '010-1234-1234', col12: '-', col13: 'Y', col14: '2022-10-10', col15: '-', col16: 'L20' },
    { col1: '고객명 의심', col2: '2022-10-01', col3: '1234-567890', col4: '000000000', col5: '김고객', col6: '12345', col7: '서울 관악구 난곡로 00길 1-1 교원A동 105호', col8: '삼성 건조기 9kg', col9: '건조기(DV90T5540)', col10: '02-111-1234', col11: '010-1234-1234', col12: '-', col13: 'Y', col14: '2022-10-10', col15: '-', col16: 'L20' },
    { col1: '고객명 의심', col2: '2022-10-01', col3: '1234-567890', col4: '000000000', col5: '김고객', col6: '12345', col7: '서울 관악구 난곡로 00길 1-1 교원A동 105호', col8: '삼성 건조기 9kg', col9: '건조기(DV90T5540)', col10: '02-111-1234', col11: '010-1234-1234', col12: '-', col13: 'Y', col14: '2022-10-10', col15: '-', col16: 'L20' },
    { col1: '고객명 의심', col2: '2022-10-01', col3: '1234-567890', col4: '000000000', col5: '김고객', col6: '12345', col7: '서울 관악구 난곡로 00길 1-1 교원A동 105호', col8: '삼성 건조기 9kg', col9: '건조기(DV90T5540)', col10: '02-111-1234', col11: '010-1234-1234', col12: '-', col13: 'Y', col14: '2022-10-10', col15: '-', col16: 'L20' },
  ]);
