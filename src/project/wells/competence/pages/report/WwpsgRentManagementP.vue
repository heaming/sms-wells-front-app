...
****************************************************************************************************
1. 모듈 : PSG
2. 프로그램 ID : WwpsgRentManagementM - 임차관리 팝업 (K-W-GM-U-0041P01)
3. 작성자 : jungsu.kim
4. 작성일 : 2023.05.16
****************************************************************************************************
* 프로그램 설명
...
import { codeUtil, defineGrid, getComponentType, gridUtil, useDataService, useGlobal, useMeta, modal, useModal } from 'kw-lib';
...
async function setRentInfo() {
  ...
  searchParams.value.cralLocaraTno = props.rowData.cralLocaraTno;
  searchParams.value.mexnoEncr = props.rowData.mexnoEncr;
  searchParams.value.cralIdvTno = props.rowData.cralIdvTno;
