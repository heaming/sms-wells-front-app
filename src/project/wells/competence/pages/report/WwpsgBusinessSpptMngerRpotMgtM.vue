...
****************************************************************************************************
1. 모듈 : PSG
2. 프로그램 ID : WwpsgBusinessSpptMngerRpotMgtM - 업무지원매니저 보고서 관리  (K-W-GM-U-0042M01)
3. 작성자 : jungsu.kim
4. 작성일 : 2023.05.16
****************************************************************************************************
* 프로그램 설명
****************************************************************************************************
업무지원매니저 보고서 관리 조회 화면
****************************************************************************************************
--->
<template>
  <kw-page>
...
async function getBusinessType() {
  const optionParams = { rpotBizTpDvCd: '02',
    ogCds: ['70632', '71321', '71301', '70533', '70529', '70532', '70078', '71776', '71774', '75050', '71948',
      '70653', '71314', '71361', '71356', '70202', '71309', '71346', '71807'] };
  const businessRes = await dataService.get('/sms/wells/competence/business-support-mnger/business-type', { params: optionParams });
...
async function getBusinessTypeContent() {
  const optionParams = { rpotBizTpDvCd: '02', rpotBizTpId: saveParams.value.rpotBizTpId };
  const res = await dataService.get('/sms/wells/competence/business-support-mnger/business-type-content', { params: optionParams });
...
async function fetchData() {
  const res = await dataService.get('/sms/wells/competence/business-support-mnger/paging', { params: { ...cachedParams, ...pageInfo.value } });
...
async function onClickSave() {
  ...
  await dataService.post('/sms/wells/competence/business-support-mnger/business-manager-report', saveRows);
...
async function onClickNtccnSave() {
  ...
  await dataService.post('/sms/wells/competence/business-support-mnger/report-business-type', businessTypeParam);
  notify(t('MSG_ALT_SAVE_DATA'));
}
...
async function onClickRemove() {
  ...
  if (deletedRows.length > 0) {
    await dataService.delete('/sms/wells/competence/business-support-mnger/', { data: deletedRows });
    await onClickSearch();
  }
}
  ...
  view.onCellButtonClicked = async (g, { itemIndex, fieldName }) => {
    if (fieldName === 'prtnrNo') {
      ...
      if (result) {
        ...
        const res = await dataService.get('/sms/wells/competence/business-support-mnger/prtnr-info', { params: { ogTpCd: payload.ogTpCd, prtnrNo: payload.prtnrNo } });
