...
const rsbDvCdPersonColumnLayout = [
  ...
  },
  {
    ...
    direction: 'horizontal',
    items: ['tEnvrElhmCnt', 'fEnvrElhmCnt', 'bEnvrElhmCnt', 'dEnvrElhmCnt'],
  },
  {
    header: t('MSG_TXT_ENVR_ELHM_RENTAL_MATT'),
    direction: 'horizontal',
    items: ['tEnvrElhmRentalMatt', 'fEnvrElhmRentalMatt', 'bEnvrElhmRentalMatt', 'dEnvrElhmRentalMatt'],
  },
  {
    header: t('MSG_TXT_ENVR_ELHM_RENTAL_MATT_EXCP'),
    direction: 'horizontal',
    items: ['tEnvrElhmRentalMattExcp', 'fEnvrElhmRentalMattExcp', 'bEnvrElhmRentalMattExcp', 'dEnvrElhmRentalMattExcp'],
  },
  {
    header: t('MSG_TXT_ENVR_ELHM_SPAY'),
    direction: 'horizontal',
    items: ['tEnvrElhmSpay', 'fEnvrElhmSpay', 'bEnvrElhmSpay', 'dEnvrElhmSpay'],
  },
  {
    header: t('MSG_TXT_ENVR_ELHM_EXCP_SPAY'),
    direction: 'horizontal',
    items: ['tEnvrElhmExcpSpay', 'fEnvrElhmExcpSpay', 'bEnvrElhmExcpSpay', 'dEnvrElhmExcpSpay'],
  },
  {
...
const rsbDvCdBranchManagerColumnLayout = [
  ...
  },
  {
    ...
    direction: 'horizontal',
    items: ['tEnvrElhmCntJo', 'fEnvrElhmCntJo', 'bEnvrElhmCntJo', 'dEnvrElhmCntJo'],
  },
  {
    header: t('MSG_TXT_OG_ENVR_ELHM_RENTAL_MATT'),
    direction: 'horizontal',
    items: ['tEnvrElhmRentalMattJo', 'fEnvrElhmRentalMattJo', 'bEnvrElhmRentalMattJo', 'dEnvrElhmRentalMattJo'],
  },
  {
    header: t('MSG_TXT_OG_ENVR_ELHM_RENTAL_MATT_EXCP'),
    direction: 'horizontal',
    items: ['tEnvrElhmRentalMattExcpJo', 'fEnvrElhmRentalMattExcpJo', 'bEnvrElhmRentalMattExcpJo', 'dEnvrElhmRentalMattExcpJo'],
  },
  {
    header: t('MSG_TXT_OG_ENVR_ELHM_SPAY'),
    direction: 'horizontal',
    items: ['tEnvrElhmSpayJo', 'fEnvrElhmSpayJo', 'bEnvrElhmSpayJo', 'dEnvrElhmSpayJo'],
  },
  {
    header: t('MSG_TXT_OG_ENVR_ELHM_EXCP_SPAY'),
    direction: 'horizontal',
    items: ['tEnvrElhmExcpSpayJo', 'fEnvrElhmExcpSpayJo', 'bEnvrElhmExcpSpayJo', 'dEnvrElhmExcpSpayJo'],
  },
  {
    header: t('MSG_TXT_REDF_FEE'),
    direction: 'horizontal',
...
function initGrid(data, view) {
  const fields = [
    ...
    { fieldName: 'fEnvrElhmCnt', dataType: 'number' },
    { fieldName: 'bEnvrElhmCnt', dataType: 'number' },
    { fieldName: 'dEnvrElhmCnt', dataType: 'number' },
    { fieldName: 'tEnvrElhmRentalMatt', dataType: 'number' },
    { fieldName: 'fEnvrElhmRentalMatt', dataType: 'number' },
    { fieldName: 'bEnvrElhmRentalMatt', dataType: 'number' },
    { fieldName: 'dEnvrElhmRentalMatt', dataType: 'number' },
    { fieldName: 'tEnvrElhmRentalMattExcp', dataType: 'number' },
    { fieldName: 'fEnvrElhmRentalMattExcp', dataType: 'number' },
    { fieldName: 'bEnvrElhmRentalMattExcp', dataType: 'number' },
    { fieldName: 'dEnvrElhmRentalMattExcp', dataType: 'number' },
    { fieldName: 'tEnvrElhmSpay', dataType: 'number' },
    { fieldName: 'fEnvrElhmSpay', dataType: 'number' },
    { fieldName: 'bEnvrElhmSpay', dataType: 'number' },
    { fieldName: 'dEnvrElhmSpay', dataType: 'number' },
    { fieldName: 'tEnvrElhmExcpSpay', dataType: 'number' },
    { fieldName: 'fEnvrElhmExcpSpay', dataType: 'number' },
    { fieldName: 'bEnvrElhmExcpSpay', dataType: 'number' },
    { fieldName: 'dEnvrElhmExcpSpay', dataType: 'number' },
    { fieldName: 'tEnvrElhmCntJo', dataType: 'number' },
    { fieldName: 'fEnvrElhmCntJo', dataType: 'number' },
    { fieldName: 'bEnvrElhmCntJo', dataType: 'number' },
    { fieldName: 'dEnvrElhmCntJo', dataType: 'number' },
    { fieldName: 'tEnvrElhmRentalMattJo', dataType: 'number' },
    { fieldName: 'fEnvrElhmRentalMattJo', dataType: 'number' },
    { fieldName: 'bEnvrElhmRentalMattJo', dataType: 'number' },
    { fieldName: 'dEnvrElhmRentalMattJo', dataType: 'number' },
    { fieldName: 'tEnvrElhmRentalMattExcpJo', dataType: 'number' },
    { fieldName: 'fEnvrElhmRentalMattExcpJo', dataType: 'number' },
    { fieldName: 'bEnvrElhmRentalMattExcpJo', dataType: 'number' },
    { fieldName: 'dEnvrElhmRentalMattExcpJo', dataType: 'number' },
    { fieldName: 'tEnvrElhmSpayJo', dataType: 'number' },
    { fieldName: 'fEnvrElhmSpayJo', dataType: 'number' },
    { fieldName: 'bEnvrElhmSpayJo', dataType: 'number' },
    { fieldName: 'dEnvrElhmSpayJo', dataType: 'number' },
    { fieldName: 'tEnvrElhmExcpSpayJo', dataType: 'number' },
    { fieldName: 'fEnvrElhmExcpSpayJo', dataType: 'number' },
    { fieldName: 'bEnvrElhmExcpSpayJo', dataType: 'number' },
    { fieldName: 'dEnvrElhmExcpSpayJo', dataType: 'number' },
  ...
  const columns = [
    ...
    /* 환경가전 - 개인 */
    { fieldName: 'tEnvrElhmCnt', header: t('MSG_TXT_BLNG_MM_PERF'), width: '100', styleName: 'text-right', numberFormat: '#,##0' },
    { fieldName: 'fEnvrElhmCnt', header: t('MSG_TXT_REDF_BF_PERF'), width: '100', styleName: 'text-right', numberFormat: '#,##0' },
    { fieldName: 'bEnvrElhmCnt', header: t('MSG_TXT_REDF_AF_PERF'), width: '100', styleName: 'text-right', numberFormat: '#,##0' },
    { fieldName: 'dEnvrElhmCnt', header: t('MSG_TXT_REDF_PERF1'), width: '100', styleName: 'text-right', numberFormat: '#,##0' },
    /* 환경가전 렌탈(매트리스) - 개인 */
    { fieldName: 'tEnvrElhmRentalMatt', header: t('MSG_TXT_BLNG_MM_PERF'), width: '100', styleName: 'text-right', numberFormat: '#,##0' },
    { fieldName: 'fEnvrElhmRentalMatt', header: t('MSG_TXT_REDF_BF_PERF'), width: '100', styleName: 'text-right', numberFormat: '#,##0' },
    { fieldName: 'bEnvrElhmRentalMatt', header: t('MSG_TXT_REDF_AF_PERF'), width: '100', styleName: 'text-right', numberFormat: '#,##0' },
    { fieldName: 'dEnvrElhmRentalMatt', header: t('MSG_TXT_REDF_PERF1'), width: '100', styleName: 'text-right', numberFormat: '#,##0' },
    /* 환경가전 렌탈(매트리스 외) - 개인 */
    { fieldName: 'tEnvrElhmRentalMattExcp', header: t('MSG_TXT_BLNG_MM_PERF'), width: '100', styleName: 'text-right', numberFormat: '#,##0' },
    { fieldName: 'fEnvrElhmRentalMattExcp', header: t('MSG_TXT_REDF_BF_PERF'), width: '100', styleName: 'text-right', numberFormat: '#,##0' },
    { fieldName: 'bEnvrElhmRentalMattExcp', header: t('MSG_TXT_REDF_AF_PERF'), width: '100', styleName: 'text-right', numberFormat: '#,##0' },
    { fieldName: 'dEnvrElhmRentalMattExcp', header: t('MSG_TXT_REDF_PERF1'), width: '100', styleName: 'text-right', numberFormat: '#,##0' },
    /* 환경가전 일시불 - 개인 */
    { fieldName: 'tEnvrElhmSpay', header: t('MSG_TXT_BLNG_MM_PERF'), width: '100', styleName: 'text-right  ', numberFormat: '#,##0' },
    { fieldName: 'fEnvrElhmSpay', header: t('MSG_TXT_REDF_BF_PERF'), width: '100', styleName: 'text-right', numberFormat: '#,##0' },
    { fieldName: 'bEnvrElhmSpay', header: t('MSG_TXT_REDF_AF_PERF'), width: '100', styleName: 'text-right', numberFormat: '#,##0' },
    { fieldName: 'dEnvrElhmSpay', header: t('MSG_TXT_REDF_PERF1'), width: '100', styleName: 'text-right', numberFormat: '#,##0' },
    /* 환경가전 외 일시불 - 개인 */
    { fieldName: 'tEnvrElhmExcpSpay', header: t('MSG_TXT_BLNG_MM_PERF'), width: '100', styleName: 'text-right', numberFormat: '#,##0' },
    { fieldName: 'fEnvrElhmExcpSpay', header: t('MSG_TXT_REDF_BF_PERF'), width: '100', styleName: 'text-right', numberFormat: '#,##0' },
    { fieldName: 'bEnvrElhmExcpSpay', header: t('MSG_TXT_REDF_AF_PERF'), width: '100', styleName: 'text-right', numberFormat: '#,##0' },
    { fieldName: 'dEnvrElhmExcpSpay', header: t('MSG_TXT_REDF_PERF1'), width: '100', styleName: 'text-right', numberFormat: '#,##0' },

    /* 조직 환경가전 */
    { fieldName: 'tEnvrElhmCntJo', header: t('MSG_TXT_BLNG_MM_PERF'), width: '100', styleName: 'text-right', numberFormat: '#,##0' },
    { fieldName: 'fEnvrElhmCntJo', header: t('MSG_TXT_REDF_BF_PERF'), width: '100', styleName: 'text-right', numberFormat: '#,##0' },
    { fieldName: 'bEnvrElhmCntJo', header: t('MSG_TXT_REDF_AF_PERF'), width: '100', styleName: 'text-right', numberFormat: '#,##0' },
    { fieldName: 'dEnvrElhmCntJo', header: t('MSG_TXT_REDF_PERF1'), width: '100', styleName: 'text-right', numberFormat: '#,##0' },
    /* 조직 환경가전 렌탈(매트리스) */
    { fieldName: 'tEnvrElhmRentalMattJo', header: t('MSG_TXT_BLNG_MM_PERF'), width: '100', styleName: 'text-right', numberFormat: '#,##0' },
    { fieldName: 'fEnvrElhmRentalMattJo', header: t('MSG_TXT_REDF_BF_PERF'), width: '100', styleName: 'text-right', numberFormat: '#,##0' },
    { fieldName: 'bEnvrElhmRentalMattJo', header: t('MSG_TXT_REDF_AF_PERF'), width: '100', styleName: 'text-right', numberFormat: '#,##0' },
    { fieldName: 'dEnvrElhmRentalMattJo', header: t('MSG_TXT_REDF_PERF1'), width: '100', styleName: 'text-right', numberFormat: '#,##0' },
    /* 조직 환경가전 렌탈(매트리스 외) */
    { fieldName: 'tEnvrElhmRentalMattExcpJo', header: t('MSG_TXT_BLNG_MM_PERF'), width: '100', styleName: 'text-right', numberFormat: '#,##0' },
    { fieldName: 'fEnvrElhmRentalMattExcpJo', header: t('MSG_TXT_REDF_BF_PERF'), width: '100', styleName: 'text-right', numberFormat: '#,##0' },
    { fieldName: 'bEnvrElhmRentalMattExcpJo', header: t('MSG_TXT_REDF_AF_PERF'), width: '100', styleName: 'text-right', numberFormat: '#,##0' },
    { fieldName: 'dEnvrElhmRentalMattExcpJo', header: t('MSG_TXT_REDF_PERF1'), width: '100', styleName: 'text-right', numberFormat: '#,##0' },
    /* 조직 환경가전 일시불 */
    { fieldName: 'tEnvrElhmSpayJo', header: t('MSG_TXT_BLNG_MM_PERF'), width: '100', styleName: 'text-right', numberFormat: '#,##0' },
    { fieldName: 'fEnvrElhmSpayJo', header: t('MSG_TXT_REDF_BF_PERF'), width: '100', styleName: 'text-right', numberFormat: '#,##0' },
    { fieldName: 'bEnvrElhmSpayJo', header: t('MSG_TXT_REDF_AF_PERF'), width: '100', styleName: 'text-right', numberFormat: '#,##0' },
    { fieldName: 'dEnvrElhmSpayJo', header: t('MSG_TXT_REDF_PERF1'), width: '100', styleName: 'text-right', numberFormat: '#,##0' },
    /* 조직 환경가전 외 일시불 */
    { fieldName: 'tEnvrElhmExcpSpayJo', header: t('MSG_TXT_BLNG_MM_PERF'), width: '100', styleName: 'text-right', numberFormat: '#,##0' },
    { fieldName: 'fEnvrElhmExcpSpayJo', header: t('MSG_TXT_REDF_BF_PERF'), width: '100', styleName: 'text-right', numberFormat: '#,##0' },
    { fieldName: 'bEnvrElhmExcpSpayJo', header: t('MSG_TXT_REDF_AF_PERF'), width: '100', styleName: 'text-right', numberFormat: '#,##0' },
    { fieldName: 'dEnvrElhmExcpSpayJo', header: t('MSG_TXT_REDF_PERF1'), width: '100', styleName: 'text-right', numberFormat: '#,##0' },
    /* 되물림 수수료 - 개인 */
