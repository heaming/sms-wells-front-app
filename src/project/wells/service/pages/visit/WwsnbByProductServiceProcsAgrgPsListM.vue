...
const initGrdMain = defineGrid((data, view) => {
  ...
  const columns = [
    ...
    { fieldName: 'cnt1111', header: t('MSG_TXT_IST_REQD'), width: '96', styleName: 'text-right', footer: { text: '합계', expression: 'sum' } },
    { fieldName: 'cnt1122', header: t('MSG_TXT_MYCO_NCLT'), width: '96', styleName: 'text-right', footer: { text: '합계', expression: 'sum' } },
    { fieldName: 'cnt1121', header: t('MSG_TXT_MYCO_CLN'), width: '96', styleName: 'text-right', footer: { text: '합계', expression: 'sum' } },
    { fieldName: 'cnt1124', header: t('MSG_TXT_OCO_NCLT'), width: '96', styleName: 'text-right', footer: { text: '합계', expression: 'sum' } },
    { fieldName: 'cnt1123', header: t('MSG_TXT_OCO_CLN'), width: '96', styleName: 'text-right', footer: { text: '합계', expression: 'sum' } },
    { fieldName: 'cnt1125', header: t('MSG_TXT_MYCO_SEP'), width: '96', styleName: 'text-right', footer: { text: '합계', expression: 'sum' } },
    { fieldName: 'cnt1100', header: t('MSG_TXT_SBSUM'), width: '96', styleName: 'text-right', footer: { text: '합계', expression: 'sum' } },
    { fieldName: 'cnt3420', header: t('MSG_TXT_SL_CAN'), width: '96', styleName: 'text-right', footer: { text: '합계', expression: 'sum' } },
    { fieldName: 'cnt3410', header: t('MSG_TXT_PD_CAN'), width: '96', styleName: 'text-right', footer: { text: '합계', expression: 'sum' } },
    { fieldName: 'cnt3310', header: t('MSG_TXT_RELO_SEP'), width: '96', styleName: 'text-right', footer: { text: '합계', expression: 'sum' } },
    { fieldName: 'cnt3320', header: t('MSG_TXT_RELO_REIST'), width: '96', styleName: 'text-right', footer: { text: '합계', expression: 'sum' } },
    { fieldName: 'cnt3210', header: t('MSG_TXT_PDCT_CAUS'), width: '96', styleName: 'text-right', footer: { text: '합계', expression: 'sum' } },
    { fieldName: 'cnt3230', header: t('MSG_TXT_CST_CAUS'), width: '96', styleName: 'text-right', footer: { text: '합계', expression: 'sum' } },
    { fieldName: 'cnt3110', header: t('MSG_TXT_PDCT_AS'), width: '96', styleName: 'text-right', footer: { text: '합계', expression: 'sum' } },
    { fieldName: 'cnt3112', header: t('MSG_TXT_SPC_AS'), width: '96', styleName: 'text-right', footer: { text: '합계', expression: 'sum' } },
    { fieldName: 'cnt3121', header: t('MSG_TXT_FILT_BFSVC'), width: '96', styleName: 'text-right', footer: { text: '합계', expression: 'sum' } },
    { fieldName: 'cnt3122', header: t('MSG_TXT_FILT_VST_SELL'), width: '96', styleName: 'text-right', footer: { text: '합계', expression: 'sum' } },
    { fieldName: 'cnt3130', header: t('MSG_TXT_ENVR_CHK'), width: '96', styleName: 'text-right', footer: { text: '합계', expression: 'sum' } },
    { fieldName: 'cnt3460', header: t('MSG_TXT_PCSV_RTNGD'), width: '96', styleName: 'text-right', footer: { text: '합계', expression: 'sum' } },
    { fieldName: 'cnt3440', header: t('MSG_TXT_CO_IST'), width: '96', styleName: 'text-right', footer: { text: '합계', expression: 'sum' } },
    { fieldName: 'cnt3199', header: t('MSG_TXT_ETC'), width: '96', styleName: 'text-right', footer: { text: '합계', expression: 'sum' } },
    { fieldName: 'cnt3100', header: t('MSG_TXT_SBSUM'), width: '96', styleName: 'text-right', footer: { text: '합계', expression: 'sum' } },
    { fieldName: 'cnt1390', header: t('MSG_TXT_SBSUM'), width: '96', styleName: 'text-right', footer: { text: '합계', expression: 'sum' } },
    { fieldName: 'cnt2100', header: t('MSG_TXT_SBSUM'), width: '96', styleName: 'text-right', footer: { text: '합계', expression: 'sum' } },
    { fieldName: 'cntt', header: t('MSG_TXT_TOT_SUM'), width: '96', styleName: 'text-right', footer: { text: '합계', expression: 'sum' } },
  ];
