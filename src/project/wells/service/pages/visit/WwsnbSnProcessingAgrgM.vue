...
const initRgrpGrid = defineGrid((data, view) => {
  const columns = [
    ...
    { fieldName: 'bmKnm',
      header: t('MSG_TXT_HODT'),
      width: '106',
      styleName: 'text-center',
    },
    { fieldName: 'bsCntrTotal',
      header: t('MSG_TXT_THM') + t('MSG_TXT_BS'),
      width: '100',
      styleName: 'text-right',
      dataType: 'number',
      numberFormat: '#,###',
      footer: { expression: 'sum', numberFormat: '###,###,##0', styleName: 'text-center text-blue' },
    },
    { fieldName: 'bsCntrObj',
    ...
    { fieldName: 'reReqTotal',
      ...
      numberFormat: '#,###',
      footer: { expression: 'sum', numberFormat: '###,###,##0', styleName: 'text-center text-blue' } },
    { fieldName: 'stickTotal',
      header: t('MSG_TXT_STICK'),
      width: '86',
      styleName: 'text-right',
      dataType: 'number',
      numberFormat: '#,###',
      footer: { expression: 'sum', numberFormat: '###,###,##0', styleName: 'text-center text-blue' } },
    { fieldName: 'ratStickTotal',
      header: t('MSG_TXT_STICK_RT'),
      width: '61',
      styleName: 'text-right',
      dataType: 'number',
      numberFormat: '#,###.##%',
      footer: { expression: 'avg', numberFormat: '#,###.##%', styleName: 'text-center text-blue' } },
    { fieldName: 'scanTotal',
      header: t('MSG_TXT_SCN'),
      width: '94',
      styleName: 'text-right',
      dataType: 'number',
      numberFormat: '#,###',
      footer: { expression: 'sum', numberFormat: '###,###,##0', styleName: 'text-center text-blue' } },
    { fieldName: 'handTotal',
      header: t('MSG_BTN_HDWR_IN'),
      width: '94',
      styleName: 'text-right',
      dataType: 'number',
      numberFormat: '#,###',
      footer: { expression: 'sum', numberFormat: '###,###,##0', styleName: 'text-center text-blue' } },
    { fieldName: 'ratScanTotal',
      header: t('MSG_TXT_SCAN_RT'),
      width: '94',
      styleName: 'text-right',
      dataType: 'number',
      numberFormat: '#,###.##%',
...
const initSnGrid = defineGrid((data, view) => {
  const columns = [
    ...
    { fieldName: 'bsCntrTotal', header: t('MSG_TXT_THM') + t('MSG_TXT_BS'), width: '100', styleName: 'text-right', dataType: 'number', numberFormat: '#,###', footer: { expression: 'sum', numberFormat: '###,###,##0', styleName: 'text-center text-blue' } },
    { fieldName: 'bsCntrObj',
      header: t('MSG_TXT_OBJ'),
      width: '86',
      styleName: 'text-right',
    ...
    { fieldName: 'ratScanTotal',
      ...
      dataType: 'number',
      numberFormat: '#,###.##%',
      footer: { expression: 'avg', numberFormat: '###.##%', styleName: 'text-right text-blue' } },
    { fieldName: 'curMmRe',
      header: t('MSG_TXT_OBJ'),
      width: '86',
      styleName: 'text-right',
