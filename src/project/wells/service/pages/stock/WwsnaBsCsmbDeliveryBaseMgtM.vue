...
const initGrdMain = defineGrid((data, view) => {
  ...
  const columns = [
    ...
    { fieldName: 'nwcmrTpNm', header: t('MSG_TXT_DDLV_TP'), width: '100', styleName: 'text-center' },
    { fieldName: 'nwcmrCmptBaseNm', header: t('MSG_TXT_DDLV_CMPT_BASE'), width: '100', styleName: 'text-center' },
    ...
    { fieldName: 'indvTpNm', header: t('MSG_TXT_DDLV_TP'), width: '100', styleName: 'text-center' },
    { fieldName: 'indvCmptBaseNm', header: t('MSG_TXT_DDLV_CMPT_BASE'), width: '100', styleName: 'text-center' },
    ...
    { fieldName: 'bldTpNm', header: t('MSG_TXT_DDLV_TP'), width: '100', styleName: 'text-center' },
    { fieldName: 'bldCmptBaseNm', header: t('MSG_TXT_DDLV_CMPT_BASE'), width: '100', styleName: 'text-center' },
