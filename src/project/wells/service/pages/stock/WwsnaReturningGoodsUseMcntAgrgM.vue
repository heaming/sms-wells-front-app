...
const initGrdMain = defineGrid((data, view) => {
  ...
  const columns = [
    ...
    { fieldName: 'pdCd', header: t('MSG_TXT_ITM_CD'), width: '90', styleName: 'text-center' },
    { fieldName: 'pdNm', header: t('MSG_TXT_ITM_NM'), width: '200', styleName: 'text-left' },
    { fieldName: 'useMcn1', header: '1', width: '50', styleName: 'text-right' },
    { fieldName: 'useMcn2', header: '2', width: '50', styleName: 'text-right' },
    { fieldName: 'useMcn36', header: '3~6', width: '50', styleName: 'text-right' },
    { fieldName: 'useMcn712', header: '7~12', width: '50', styleName: 'text-right' },
    { fieldName: 'useMcn1324', header: '13~24', width: '50', styleName: 'text-right' },
    { fieldName: 'useMcn2536', header: '25~36', width: '50', styleName: 'text-right' },
    { fieldName: 'useMcn3748', header: '37~48', width: '50', styleName: 'text-right' },
    { fieldName: 'useMcn4960', header: '49~60', width: '50', styleName: 'text-right' },
    { fieldName: 'useMcn6172', header: '61~72', width: '50', styleName: 'text-right' },
    { fieldName: 'useMcn7384', header: '73~84', width: '50', styleName: 'text-right' },
    { fieldName: 'useMcn85', header: '85~', width: '50', styleName: 'text-right' },
    { fieldName: 'useMcnT', header: t('MSG_TXT_SUM'), width: '50', styleName: 'text-right' },
  ];
