...
const initGrdMain = defineGrid((data, view) => {
  ...
  const columns = [
    ...
    { fieldName: 'btdStocQty', header: t('MSG_TXT_BTD_STOC_QTY'), width: '120', styleName: 'text-right', numberFormat: '#,##0' },
    // 입고정보
    { fieldName: 'prchsQty', header: `${t('MSG_TXT_PRCHS')}${t('MSG_TXT_STR')}`, width: '120', styleName: 'text-right', numberFormat: '#,##0' },
    { fieldName: 'nomStrQty', header: `${t('MSG_TXT_NOM')}${t('MSG_TXT_STR')}`, width: '120', styleName: 'text-right', numberFormat: '#,##0' },
    { fieldName: 'qomAsnStrQty', header: `${t('MSG_TXT_QOM')}${t('MSG_TXT_ASGN')}`, width: '120', styleName: 'text-right', numberFormat: '#,##0' },
    { fieldName: 'qomMmtStrQty', header: `${t('MSG_TXT_QOM')}${t('MSG_TXT_MOVE')}`, width: '120', styleName: 'text-right', numberFormat: '#,##0' },
    { fieldName: 'rtngdStrInsiQty', header: t('MSG_TXT_INSI'), width: '120', styleName: 'text-right', numberFormat: '#,##0' },
    { fieldName: 'rtngdStrOtsdQty', header: t('MSG_TXT_OTSD'), width: '120', styleName: 'text-right', numberFormat: '#,##0' },
    { fieldName: 'etcStrQty', header: `${t('MSG_TXT_ETC')}${t('MSG_TXT_STR')}`, width: '120', styleName: 'text-right', numberFormat: '#,##0' },
    { fieldName: 'strCtrQty', header: `${t('MSG_TXT_GD')}${t('MSG_TXT_CTR')}`, width: '120', styleName: 'text-right', numberFormat: '#,##0' },
    { fieldName: 'stocAcinspStrQty', header: t('MSG_TXT_STOC_ACINSP'), width: '120', styleName: 'text-right', numberFormat: '#,##0' },
    // 출고정보
    { fieldName: 'qomAsnOstrQty', header: `${t('MSG_TXT_QOM')}${t('MSG_TXT_ASGN')}`, width: '120', styleName: 'text-right', numberFormat: '#,##0' },
    { fieldName: 'nomOstrQty', header: `${t('MSG_TXT_NOM')}${t('MSG_TXT_OSTR')}`, width: '120', styleName: 'text-right', numberFormat: '#,##0' },
    { fieldName: 'qomMmtOstrQty', header: `${t('MSG_TXT_QOM')}${t('MSG_TXT_MOVE')}`, width: '120', styleName: 'text-right', numberFormat: '#,##0' },
    { fieldName: 'rtngdOstrInsiQty', header: t('MSG_TXT_INSI'), width: '120', styleName: 'text-right', numberFormat: '#,##0' },
    { fieldName: 'rtngdOstrOtsdQty', header: t('MSG_TXT_OTSD'), width: '120', styleName: 'text-right', numberFormat: '#,##0' },
    { fieldName: 'sellOstrQty', header: `${t('MSG_TXT_SELL')}${t('MSG_TXT_OSTR')}`, width: '120', styleName: 'text-right', numberFormat: '#,##0' },
    { fieldName: 'dsuOstrQty', header: `${t('MSG_TXT_DSCD')}${t('MSG_TXT_OSTR')}`, width: '120', styleName: 'text-right', numberFormat: '#,##0' },
    { fieldName: 'wkOstrQty', header: `${t('MSG_TXT_OSTR_WK')}${t('MSG_TXT_OSTR')}`, width: '120', styleName: 'text-right', numberFormat: '#,##0' },
    { fieldName: 'refrOstrQty', header: `${t('MSG_TXT_REFR')}${t('MSG_TXT_OSTR')}`, width: '120', styleName: 'text-right', numberFormat: '#,##0' },
    { fieldName: 'etcOstrQty', header: `${t('MSG_TXT_ETC')}${t('MSG_TXT_OSTR')}`, width: '120', styleName: 'text-right', numberFormat: '#,##0' },
    { fieldName: 'ostrCtrQty', header: `${t('MSG_TXT_GD')}${t('MSG_TXT_CTR')}`, width: '120', styleName: 'text-right', numberFormat: '#,##0' },
    { fieldName: 'stocAcinspQty', header: t('MSG_TXT_STOC_ACINSP'), width: '120', styleName: 'text-right', numberFormat: '#,##0' },
    // 기말재고
    { fieldName: 'pitmStocQty', header: t('MSG_TXT_EOT_STOC_QTY'), width: '120', styleName: 'text-right', numberFormat: '#,##0' },
  ];
