...
const initGrid = defineGrid((data, view) => {
  ...
  const columns = [
    ...
    { fieldName: 'vlStrtDtm', header: t('MSG_TXT_START_DATE'), width: '135', styleName: 'text-center', rules: 'required', dataType: 'date', datetimeFormat: 'date', editable: true, editor: { type: 'btdate' } },
    { fieldName: 'vlEndDtm', header: t('MSG_TXT_END_DATE'), width: '135', styleName: 'text-center', rules: 'required', dataType: 'date', datetimeFormat: 'date', editable: true, editor: { type: 'btdate' } },
