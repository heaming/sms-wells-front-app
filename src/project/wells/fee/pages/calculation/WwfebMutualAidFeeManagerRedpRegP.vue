...
****************************************************************************************************
1. 모듈 : FEB
2. 프로그램 ID : WwfebMutualAidFeeManagerRedpRegP  - 상조 수수료 관리(M조직용) -> 수수료 되물림 생성
3. 작성자 : 37612
4. 작성일 : 2023.12.07
****************************************************************************************************
* 프로그램 설명
...
async function onClickCreate() {
  ...
  await dataService.post('/sms/wells/fee/mutual-aid-manager/create-redf', { baseYm: regData.value.baseYm });
  ok(true);
