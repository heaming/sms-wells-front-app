...
const initGrd1Main = defineGrid((data, view) => {
  ...
  const columns = [
    ...
    { fieldName: 'akcda12',
      header: t('MSG_TXT_MTRRS') + t('MSG_TXT_EXCP'),
      width: '119.9',
      styleName: 'text-right',
      numberFormat: '#,##0',
      headerSummary: {
    ...
    { fieldName: 'akcda13',
      header: t('MSG_TXT_ENVR') + t('MSG_TXT_ELHM'),
      width: '158.4',
      styleName: 'text-right',
      numberFormat: '#,##0',
      headerSummary: {
    ...
    { fieldName: 'akcda11',
      header: t('MSG_TXT_HOME_CARE') + t('MSG_TXT_PKG'),
      width: '158.4',
      styleName: 'text-right',
      numberFormat: '#,##0',
      headerSummary: {
    ...
    { fieldName: 'dedeq3',
      header: `${t('MSG_TXT_CHNG')}(1)${t('MSG_TXT_COUNT')}`,
      width: '158.4',
      styleName: 'text-right',
      numberFormat: '#,##0',
      headerSummary: {
    ...
    { fieldName: 'akdeq0',
      header: t('MSG_TXT_COM_TOT') + t('MSG_TXT_SELL') + t('MSG_TXT_COUNT'),
      width: '158.4',
      styleName: 'text-right',
      numberFormat: '#,##0',
      headerSummary: {
    ...
    { fieldName: 'lccnt1',
      header: t('MSG_TXT_ASGN') + t('MSG_TXT_COUNT'),
      width: '158.4',
      styleName: 'text-right',
      numberFormat: '#,##0',
      headerSummary: {
    ...
    { fieldName: 'cLccnt1',
      header: t('MSG_TXT_CANCEL') + t('MSG_TXT_COUNT'),
      width: '158.4',
      styleName: 'text-right',
      numberFormat: '#,##0',
      headerSummary: {
    ...
    { fieldName: 'rLccnt1',
      header: t('MSG_TXT_REAL') + t('MSG_TXT_ASGN') + t('MSG_TXT_CNT'),
      width: '207.4',
      styleName: 'text-right',
      numberFormat: '#,##0',
      headerSummary: {
    ...
    { fieldName: 'gdSercnt',
      header: `${t('MSG_TXT_WASHER')}/${t('MSG_TXT_ARCN')}/${t('MSG_TXT_DRYER')}${t('MSG_TXT_COUNT')}`,
      width: '207.4',
      styleName: 'text-right',
      numberFormat: '#,##0',
      headerSummary: {
    ...
    { fieldName: 'nelecnt',
      header: t('MSG_TXT_ELHM_EXCP') + t('MSG_TXT_COUNT'),
      width: '158.4',
      styleName: 'text-right',
      numberFormat: '#,##0',
      headerSummary: {
    ...
    { fieldName: 'sercnt',
      header: t('MSG_TXT_COM_TOT') + t('MSG_TXT_SERVICE') + t('MSG_TXT_COUNT'),
      width: '158.4',
      styleName: 'text-right',
      numberFormat: '#,##0',
      headerSummary: {
    ...
    { fieldName: 'aksd06',
      header: t('MSG_TXT_SERVICE') + t('MSG_TXT_SCENE'),
      width: '158.4',
      styleName: 'text-right',
      numberFormat: '#,##0',
      headerSummary: {
    ...
    { fieldName: 'aksd07',
      header: t('MSG_TXT_SERVICE') + t('MSG_TXT_ACTI'),
      width: '158.4',
      styleName: 'text-right',
      numberFormat: '#,##0',
      headerSummary: {
    ...
    { fieldName: 'aksd09',
      header: t('MSG_TXT_SERVICE') + t('MSG_TXT_ACML'),
      width: '158.4',
      styleName: 'text-right',
      numberFormat: '#,##0',
      headerSummary: {
    ...
    { fieldName: 'earlSettleFee',
      header: t('MSG_TXT_EARLY_STTLMNT') + t('MSG_TXT_FEE'),
      width: '158.4',
      styleName: 'text-right',
      numberFormat: '#,##0',
      headerSummary: {
  ...
  view.setColumnLayout([
    {
      ...
      items: [{ column: 'dgr2LevlOgNm', summaryUserSpans: [{ colspan: 9 }] }, 'dgr3LevlOgNm', 'prtnrNo', 'prtnrKnm', 'rsbDvCd', 'akdsym', 'akdcha', 'prtnrGdCd'],
    },
    'edu100',
    {
...
const initGrd2Main = defineGrid((data, view) => {
  const fields = [
    ...
    { fieldName: 'akdcha' },
    { fieldName: 'prtnrGdCd' },
    { fieldName: 'atcnt1', dataType: 'number' },
    { fieldName: 'atcnt2', dataType: 'number' },
    { fieldName: 'is124edu', dataType: 'number' },
    { fieldName: 'is125edu', dataType: 'number' },
    { fieldName: 'akcda10', dataType: 'number' },
    { fieldName: 'akcda12', dataType: 'number' },
    { fieldName: 'akcda14', dataType: 'number' },
    { fieldName: 'akcda13', dataType: 'number' },
  ...
  const columns = [
    ...
    { fieldName: 'prtnrGdCd', header: t('MSG_TXT_GRCNT'), width: '119.9', styleName: 'text-right', numberFormat: '#,##0.##' },
    { fieldName: 'atcnt1',
      header: t('MSG_TXT_ASET') + t('MSG_TXT_EDUC'),
      width: '119.9',
      styleName: 'text-right',
      headerSummary: {
        numberFormat: '#,##0',
    ...
    { fieldName: 'atcnt2',
      header: t('MSG_TXT_ACPN') + t('MSG_TXT_EDUC'),
      width: '119.9',
      styleName: 'text-right',
      headerSummary: {
        numberFormat: '#,##0',
    ...
    { fieldName: 'jSercnt',
      header: t('MSG_TXT_SERVICE') + t('MSG_TXT_COUNT'),
      width: '119.9',
      styleName: 'text-right',
      numberFormat: '#,###,##0',
      headerSummary: {
    ...
    { fieldName: 'aksd52',
      header: `${t('MSG_TXT_SNGL_PMNT')}/${t('MSG_TXT_ISTM')}`,
      width: '119.9',
      styleName: 'text-right',
      numberFormat: '#,###,##0',
      headerSummary: {
    ...
    { fieldName: 'aksd53',
      header: t('MSG_TXT_SELL') + t('MSG_TXT_CONN'),
      width: '119.9',
      styleName: 'text-right',
      numberFormat: '#,###,##0',
      headerSummary: {
    ...
    { fieldName: 'aksd56',
      header: t('MSG_TXT_SERVICE') + t('MSG_TXT_CONN'),
      width: '119.9',
      styleName: 'text-right',
      numberFormat: '#,###,##0',
      headerSummary: {
  ...
  view.setColumnLayout([
    {
      header: t('MSG_TXT_PRVCY'), // colspan title
      direction: 'horizontal', // merge type
      items: [{ column: 'dgr2LevlOgNm', summaryUserSpans: [{ colspan: 8 }] }, 'dgr3LevlOgNm', 'prtnrNo', 'prtnrKnm', 'rsbDvCd', 'akdsym', 'akdcha', 'prtnrGdCd'],
    },
    {
