...
const initGrdPlar = defineGrid((data, view) => {
  const columns = [
    ...
    { fieldName: 'cntrNo', header: t('MSG_TXT_CNTR_NO'), width: '119', styleName: 'text-center' },
...
const initGrdMnger = defineGrid((data, view) => {
  const columns = [
    ...
    { fieldName: 'cstKnm', header: t('MSG_TXT_CST_NM'), width: '119', styleName: 'text-center' },
    { fieldName: 'saleDiv', header: t('MSG_TXT_SLS_CAT'), width: '119', styleName: 'text-center' },
    { fieldName: 'pdAccCnt', header: t('MSG_TXT_PD_ACC_CNT'), width: '119', styleName: 'text-right', dataType: 'number', numberFormat: '#,##0' },
    { fieldName: 'perfBsPdAccCnt', header: t('MSG_TXT_BFSVC_ACKMT_CT'), width: '119', styleName: 'text-right', dataType: 'number', numberFormat: '#,##0' },
    { fieldName: 'perfRental', header: t('MSG_TXT_ENVR_ELHM') + t('MSG_TXT_RENTAL'), width: '119', styleName: 'text-right', dataType: 'number', numberFormat: '#,##0' },
    { fieldName: 'perfSnglPmnt', header: t('MSG_TXT_ENVR_ELHM') + t('MSG_TXT_SNGL_PMNT'), width: '119', styleName: 'text-right', dataType: 'number', numberFormat: '#,##0' },
    { fieldName: 'perfFxam', header: t('MSG_TXT_ENVR_ELHM') + t('MSG_TXT_FXAM'), width: '119', styleName: 'text-right', dataType: 'number', numberFormat: '#,##0' },
  ];
