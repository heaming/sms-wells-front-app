...
const customCodes = {
  ...
  rsbDvCd: [{ codeId: '00', codeName: '전체' }, { codeId: '15', codeName: '지구장이하' }, { codeId: '7', codeName: '지점장이상' }],
};
...
const initGrd3Main = defineGrid((data, view) => {
  ...
  const columns = [
    ...
    { fieldName: 'ehPerfCnt', header: t('MSG_TXT_PD_ACC_CNT'), width: '120', styleName: 'text-center' },
    { fieldName: 'ehAmt1', header: t('MSG_TXT_RENTAL') + t('MSG_TXT_PD_STD_FEE'), width: '120', styleName: 'text-center' },
    { fieldName: 'ehAmt2', header: t('MSG_TXT_SNGL_PMNT') + t('MSG_TXT_PD_STD_FEE'), width: '120', styleName: 'text-center' },
    { fieldName: 'ehMcCnt', header: t('MSG_TXT_CHNG') + t('MSG_TXT_COUNT'), width: '120', styleName: 'text-center' },
    { fieldName: 'fxamCnt', header: t('MSG_TXT_FXAM') + t('MSG_TXT_COUNT'), width: '120', styleName: 'text-center' },
    { fieldName: 'lpkCnt', header: t('MSG_TXT_LIVE_PAKG') + t('MSG_TXT_COUNT'), width: '120', styleName: 'text-center' },
    { fieldName: 'hmbCnt', header: t('MSG_TXT_HCR_MSH') + t('MSG_TXT_COUNT'), width: '120', styleName: 'text-center' },
