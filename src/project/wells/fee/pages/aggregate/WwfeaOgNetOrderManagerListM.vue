...
const initGrd1Main = defineGrid((data, view) => {
  ...
  const columns = [
    ...
    { fieldName: 'dscSyst', header: t('MSG_TXT_DSC_SYST'), width: '83.5', styleName: 'text-right', options: codes.PMOT_TP_CD },
...
const initGrd3Main = defineGrid((data, view) => {
  const fields = [
    ...
    { fieldName: 'prtnrNo' },
    { fieldName: 'prtnrKnm' },
    { fieldName: 'pstnDvCd', dataType: 'number' },
    ...
    { fieldName: 'ehPerfCnt', dataType: 'number' },
    { fieldName: 'ehAmt1', dataType: 'number' },
    { fieldName: 'ehAmt2', dataType: 'number' },
    { fieldName: 'ehMcCnt', dataType: 'number' },
    { fieldName: 'fxamCnt', dataType: 'number' },
    { fieldName: 'lpkCnt', dataType: 'number' },
    { fieldName: 'hmbCnt', dataType: 'number' },
