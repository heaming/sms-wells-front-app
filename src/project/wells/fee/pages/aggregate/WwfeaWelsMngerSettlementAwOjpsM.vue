...
const initGrdMain = defineGrid((data, view) => {
  const fields = [
    ...
    { fieldName: 'rsbDvCd' },
    { fieldName: 'qlfDvCd' },
    { fieldName: 'nmnQlfDvNm' },
    { fieldName: 'procsDtm' },
    { fieldName: 'srtupDt' },
    { fieldName: 'preSrtupDt' },
    { fieldName: 'actiYn' },
    { fieldName: 'cntrDt' },
    { fieldName: 'cltnDt' },
    { fieldName: 'fstCntrDt' },
  ...
  const columns = [
    ...
    { fieldName: 'srtupDt', header: t('MSG_TXT_SRTUP'), width: '130', styleName: 'text-center', editable: false, datetimeFormat: 'yyyy-MM' },
    { fieldName: 'preSrtupDt', header: t('MSG_TXT_FREE_SRTUP'), width: '130', styleName: 'text-center', editable: false, datetimeFormat: 'yyyy-MM' },
    { fieldName: 'actiYn', header: t('MSG_TXT_ACTI') + t('MSG_TXT_YN'), width: '130', styleName: 'text-center', editable: false },
