...
const initGridMain = defineGrid((data, view) => {
  const columns = [
    ...
    { fieldName: 'svFeeBaseAmt', header: t('MSG_TXT_PD_STD_FEE'), width: '100', styleName: 'text-right', dataType: 'number', numberFormat: '#,##0' },
    { fieldName: 'feeUprcAmt', header: t('MSG_TXT_AGRG') + t('MSG_TXT_FEE'), width: '100', styleName: 'text-right', dataType: 'number', numberFormat: '#,##0' },
