...
function initGrid1(data, view) {
  const columns = [
    ...
    { fieldName: 'brchCt', header: t('MSG_TXT_BRCH_N'), width: '90', styleName: 'text-right', dataType: 'number', headerSummary: { text: '합계' } },
    ...
    { fieldName: 'spayElhmCt', header: t('MSG_TXT_SNGL_PMNT'), width: '100', styleName: 'text-right', dataType: 'number', summaries: [{ expression: 'sum', numberFormat: '#,##0' }] },
    { fieldName: 'rentalElhmBaseAmt', header: t('MSG_TXT_RENTAL'), width: '110', styleName: 'text-right', dataType: 'number', summaries: [{ expression: 'sum', numberFormat: '#,##0' }] },
    { fieldName: 'spayElhmBaseAmt', header: t('MSG_TXT_ISTM'), width: '100', styleName: 'text-right', dataType: 'number', summaries: [{ expression: 'sum', numberFormat: '#,##0' }] },
    { fieldName: 'notElhmAmt', header: t('MSG_TXT_ELHM_EXCP_ACKMT_PERF'), width: '110', styleName: 'text-right', dataType: 'number', summaries: [{ expression: 'sum', numberFormat: '#,##0' }] },
    { fieldName: 'vstAsnCt', header: t('MSG_TXT_ASN_ACC'), width: '100', styleName: 'text-right', dataType: 'number', summaries: [{ expression: 'sum', numberFormat: '#,##0' }] },
    { fieldName: 'vstFshCt', header: t('MSG_TXT_FSH_ACC'), width: '100', styleName: 'text-right', dataType: 'number', summaries: [{ expression: 'sum', numberFormat: '#,##0' }] },
    { fieldName: 'vstProcsRt', header: t('MSG_TXT_PROCS_RT'), width: '90', styleName: 'text-right', dataType: 'number', numberFormat: '#,##0.0;;;c', summaries: [{ expression: 'sum', numberFormat: '#,##0' }] },
    { fieldName: 'nwSellCt', header: t('MSG_TXT_NW_SELL'), width: '90', styleName: 'text-right', dataType: 'number', summaries: [{ expression: 'sum', numberFormat: '#,##0' }] },
    { fieldName: 'accNincSum', header: t('MSG_TXT_ACC_NINC'), width: '90', styleName: 'text-right', dataType: 'number', summaries: [{ expression: 'sum', numberFormat: '#,##0' }] },
  ];
